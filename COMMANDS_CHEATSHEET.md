...
## 10) Go back to main branch

한국어: 작업하다가 메인 브랜치로 돌아갈 때 사용합니다.

### 10-1) Clean switch (no local changes)

```bash
git switch main
```

### 10-2) If you have local changes (safe stash)
...
### 10-3) Go back to previous branch quickly
